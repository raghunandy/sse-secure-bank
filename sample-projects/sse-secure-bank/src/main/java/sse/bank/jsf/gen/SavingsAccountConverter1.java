 ...
 * @author Raghunath
 */
public class SavingsAccountConverter1 implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String string) {
        ...
        String id = string;
        SavingsAccountController1 controller = (SavingsAccountController1) facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(), null, "savingsAccount");
