 ...
 * @author Raghunath
 */
public class TransactionConverter1 implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String string) {
        ...
        String id = string;
        TransactionController1 controller = (TransactionController1) facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(), null, "transaction");
