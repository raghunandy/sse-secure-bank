 ...
 * @author Raghunath
 */
public class CheckinAccountConverter1 implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String string) {
        ...
        String id = string;
        CheckinAccountController1 controller = (CheckinAccountController1) facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(), null, "checkinAccount");
